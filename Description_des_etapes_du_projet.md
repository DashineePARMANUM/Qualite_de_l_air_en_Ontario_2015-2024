...
- analyser les variables disponibles et la taille du dataset
- évaluer la fiabilité et l’intégrité des données (biais potentiels, méthode de collecte)
...
- analyses descriptives (moyennes, agrégations, distributions)
...
- création de relations entre les données (modélisation de base)
- conception de visualisations interactives (graphiques, tableaux, indicateurs)
...
- l’évaluation de l’atteinte des objectifs initiaux
